...
author: Ricardo Tomáz | Cláudia Godoy | Emerson Del Ponte.
format: 
  html:
    code-fold: false
    smooth-scroll: true
...
plot_annotation(
    tag_levels = "a",              # Gera etiquetas automáticas
    tag_prefix = "(",              # Adiciona parênteses ao início
    tag_suffix = ")"               # Adiciona parênteses ao final
  )
...
plot_grid(p2,regression_graphic_res,regression_graphic_m_sus,
          regression_graphic_sus,ncol = 2,  labels = c("(a)", "(b)", "(c)", "(d)"))
